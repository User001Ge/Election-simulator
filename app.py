...
def main() -> None:
    ...
    with st.sidebar:
        ...
        candidate_1 = st.selectbox(
            "კანდიდატი 1",
            options=MODEL.candidate_options,
            index=MODEL.candidate_options.index(default_candidates[0]),
        )

        candidate_2_options = [name for name in MODEL.candidate_options if name != candidate_1]
        candidate_2_default = (
        ...
        candidate_3_options = [
            name for name in MODEL.candidate_options if name not in {candidate_1, candidate_2}
        ]
        candidate_3_default = (
